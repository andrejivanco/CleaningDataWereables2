...
setwd("C:/AI_sync/OneDrive/Work_AI/11_Training/Coursera/CleaningData/W4/Werables2")
...
names(x.mean.sd) <- features[mean.sd, 2] # getting the names
names(x.mean.sd) <- tolower(names(x.mean.sd)) # casefolding
names(x.mean.sd) <- gsub("\\(|\\)", "", names(x.mean.sd)) # cleaning
